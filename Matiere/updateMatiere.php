...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
         ...
         <?php
            ...
            $a = $_GET['$idi'];
            $update = $pdo->prepare("SELECT*FROM matiere WHERE id_matiere =$a ");
            $update->execute();
          ?>


             <?php foreach ($update as $rowup) : ?>
                  <div >
                    <h1 class="h3 mb-4 text-gray-800" >Mise a jour de la matiere  <span style="color: rgba(0, 0, 255, 0.632);"><?php echo $rowup['nom'] ?></span></h1>
                  </div>
                     <!-- DataTales Example -->
                       ...
                       <form action="./update.php"  method="post">
                             <div class="main">
                                 ...
                                 <select class="input-form"  name="ecole" id="" >
                                        <option value="<?php echo $rowup['ecole'] ?>"><?php echo $rowup['ecole'] ?></option>
                                     ...
                                     <select class="input-form"  name="dep" id="" >
                                        <option value="<?php echo $rowup['dep'] ?>"><?php echo $rowup['dep'] ?></option>
                                     ...
                                     <select class="input-form"  name="filiere" id="" >
                                        <option value="<?php echo $rowup['filiere'] ?>"><?php echo $rowup['filiere'] ?></option>
                                        <?php foreach ($results2 as $rows2): ?>
                                        <option value="<?php echo $rows2['nom_filiere'] ?>"><?php echo $rows2['nom_filiere'] ?> </option>
                                        <?php endforeach ?>  
                                     </select>
                                     <br><br>
                                     <input placeholder="Nom Matiere" name="mom_matiere" value="<?php echo $rowup['nom'] ?>" class="input-form" type="text"><br><br>
                                 ...
                                 <div class="first-main">
                                      ...
                                      <input placeholder="Nombre heure" value="<?php echo $rowup['nbr_heure'] ?>" name="nbr_heure" class="input-form" type="number"><br><br>
                                      <select class="input-form" aria-placeholder="choisir un Directeur"  name="prof" id="" >
                                        <option value="<?php echo $rowup['prof'] ?>"><?php echo $rowup['prof'] ?> </option>
                                      ...
                                      <div style="width: 80%;display: flex;justify-content: space-between;">
                                          ...
                                          <input  name="idi" style="display: none;" value="<?php echo $rowup['id_matiere'] ?>" type="text">
