...
<head>
    ...
    <link rel="stylesheet" href="./Professeur/Professeur.css">
    <link rel="stylesheet" href="./Professeur/Programme.css">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Plage horaire des Filiere</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                                ...
                                <?php
                                    ...
                                    $req = $pdo->prepare("SELECT * FROM plagehoraires");
                                    $req->execute();
                                    $result = $req->fetchAll();
                                ?>
                                            <!-- DataTales Example -->
                                                            ...
                                                            <?php foreach ($result as $row): ?>
                                                                <tr style="text-align: center;">
                                                                    <td><img width="35" height="30" src="img/undraw_profile.svg"></td>
                                                                        <td style="color: rgba(77, 77, 236, 0.775);font-weight: bold;"><?php echo $row['debut'] ?></td>
                                                                        <td ><?php echo $row['fin'] ?></td>
                                                                        <td>Administrateur</td>
                                                                        <?php $id = $row['id_plage'] ?>
                                                                        <td>
                                                                            <?php 
                                                                                echo '<a href="PlageHoraire/delete.php?$idi='.$id.'"><button class="btn btn-danger" type="submit" name="sup">Supprimer</button></a>
                                                                            ';?>
                                                                            <?php                    
                                                                            echo '<a href="#' . $id . '"><button class="btn btn-warning ">Modifier</button></a>
                                                                            ';?>
                                                                        </td>
                                                                    </tr>
                                                            <?php endforeach ?>                                       
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                   ...
                                   <form action="./PlageHoraire/insert.php"  method="post">
                                     <br><br>
                                        <div style="display: flex;justify-content: space-between;width:100%">
                                            <div style="width: 100%;">
                                                <p>Date Debut</p>
                                                <input placeholder="periode_debut" required name="periode_debut" class="input-form" type="date">
                                            </div>
                                            &nbsp;&nbsp;&nbsp;
                                            <div style="width: 100%;">
                                                <p>Date Fin</p>
                                                <input placeholder="periode_fin" required name="periode_fin" class="input-form" type="date">
                                            </div>
                                            </div><br>

                                            <hr class="sidebar-divider my-0"><br>
                                            <input class="btn btn-secondary" type="reset" value="Annuler" data-dismiss="modal">
