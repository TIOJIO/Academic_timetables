...
<div class="sidebar-card d-none d-lg-flex">
    <img class="sidebar-card-illustration mb-2" src="img/undraw_rocket.svg" alt="...">
    <p class="text-center mb-2"><strong>SHEDULE SCHOOL</strong> Pour une  plannification Horaire efficace</p>
    <a class="btn btn-success btn-sm" href="https://startbootstrap.com/theme/sb-admin-pro">SE DECONNECTER</a>
</div>
                ...
                <div class="container-fluid">
                   <br><br>
                        ...
                        <div style="width:100%;display:flex;justify-content:space-between">
                            <h1 class="h3 mb-4 text-gray-800">Matiere </h1>
                            <a href="./Matiere/addMatiere.php" style="text-decoration: none;background-color: rgba(0, 0, 255, 0.405);color:white;font-weight:bold;border-radius:5px;padding:10px;cursor:pointer;height:50px" onclick="document.getElementById('id01').style.display='block'">
                                <p>+ Nouvelle Matiere</p>
                            </a>
                        </div>
                                    ...
                                    <tbody>
                                       <?php foreach ($result as $row): ?>
                                         <tr style="text-align: center;">
                                                ...
                                                <td><?php echo $row['nbr_heure'] ?></td>
                                                <?php $id = $row['id_matiere'] ?>
                                                <td>
                                                    <?php 
                                                        echo '<a href="Matiere/delete.php?$idi='.$id.'"><button class="btn btn-danger" type="submit" name="sup">Supprimer</button></a>
                                                    ';?>
                                                    <?php                    
                                                    echo '<a href="Matiere/updateMatiere.php?$idi=' . $id . '"><button class="btn btn-warning ">Modifier</button></a>
                                                    ';?>
                                                </td>
                                            </tr>
                                    <?php endforeach ?>                                       
