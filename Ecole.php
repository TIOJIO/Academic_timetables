                ...
                <div class="container-fluid">
                   <br><br>
                        ...
                        <div style="width:100%;display:flex;justify-content:space-between">
                            <h1 class="h3 mb-4 text-gray-800">Ecole </h1>
                            <a href="./ecole/addEcole.php" style="text-decoration: none;background-color: rgba(0, 0, 255, 0.405);color:white;font-weight:bold;border-radius:5px;padding:10px;cursor:pointer;height:50px" onclick="document.getElementById('id01').style.display='block'">
                                <p>+ Nouvelle Ecole</p>
                            </a>
                        </div>
                                       ...
                                       <?php foreach ($result as $row): ?>
                                         <tr style="text-align: center;">
                                               <td><img width="35" height="30" src="img/undraw_profile.svg"></td>
                                                ...
                                                <td><?php echo $row['nbr_dep'] ?></td>
                                                <td>Administrateur</td>
                                                <?php $id = $row['id_ecole'] ?>
                                                <td>
                                                    <?php 
                                                        echo '<a href="Ecole/delete.php?$idi='.$id.'"><button class="btn btn-danger" type="submit" name="sup">Supprimer</button></a>
                                                    ';?>
                                                    <?php                    
                                                    echo '<a href="Ecole/updateEcole.php?$idi=' . $id . '"><button class="btn btn-warning ">Modifier</button></a>
                                                    ';?>
                                                </td>
                                            </tr>
                                    <?php endforeach ?>                                       
