        ...
        <div id="content-wrapper" class="d-flex flex-column">
         ...
         <?php
          ...
          ?>
                  ...
                  <h1 class="h3 mb-4 text-gray-800" >Mise a jour de  <span style="color: rgba(0, 0, 255, 0.632);"><?php echo $row['nom'] ?></span></h1>
                     <!-- DataTales Example -->
                             ...
                             <div class="main">
                                 ...
                                 <div class="first-main">
                                   <select class="input-form"  name="ecole" id="" >
                                        <option value="<?php echo $row['ecole'] ?>"><?php echo $row['ecole'] ?></option>
                                     ...
                                     <input  name="image" class="input-form" type="file" id="image">
                                      ...
                                      <div style="width: 80%;display: flex;justify-content: space-between;">
                                          ...
                                          <input  name="idi" style="display: none;" value="<?php echo $row['id_dep'] ?>" type="text">
