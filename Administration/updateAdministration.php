                   ...
                   <br><br>
                          ...
                          <?php
                             include_once('../bd/config.php');
                                ...
                                $update = $pdo->prepare("SELECT*FROM administration WHERE id_membre =$a ");
                                $update->execute();
                        ...
                        <?php foreach ($update as $row) : ?>
                                <div >
                                    <h1 class="h3 mb-4 text-gray-800">Mise A jour de <span style="color: rgba(0, 0, 255, 0.632); font-weight:bold"><?php echo $row['names'] ?> <?php echo $row['username'] ?></span> </h1>
                                </div>
                        <?php endforeach ?>
                                 ...
                                 <div class="first-main">
                                    ...
                                    <select class="input-form" placeholder="choisir une ecole"  name="poste" id="" >
                                      ...
                                      <div style="width: 80%;display: flex;justify-content: space-between;">
                                          ...
                                          <input  name="idi" style="display: none;" value="<?php echo $row['id_membre'] ?>" type="text">
