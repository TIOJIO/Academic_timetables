            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   <br><br>
                        ...
                        <!-- Page Heading -->
                        <div >
                            <h1 class="h3 mb-4 text-gray-800">Nouveau Pofesseur</h1>
                        </div>
                       ...
                       <form action="insert.php" method="post">
                             <div class="main">
                                 <div class="first-main">
                                     <input placeholder="Username" name="username" class="input-form" type="text"><br><br>
                                     <input placeholder="Name" name="names" class="input-form" type="text"><br><br>
                                     <input placeholder="Email" name="email" class="input-form" type="text"><br><br>
                                     <input placeholder="Telephone" name="tel" class="input-form" type="text"><br><br>
                                     <input placeholder="Matricule" name="matricule" class="input-form" type="text"><br><br>
