        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php
                            ...
                            $a = $_GET['$nom_filiere']; 
                            $prof = $pdo->prepare("SELECT*FROM etudiant WHERE id_etudiant =$a ");
                            $prof->execute();
                        ?>
                ...
                <?php
                    ...
                    $prof = $pdo->prepare("SELECT*FROM etudiant WHERE id_etudiant =$a ");
                    $prof->execute();
                    foreach ($prof as $rowpf){
                        $nom_filiere = $rowpf['nom_filiere'];
                    ...
                    //LUNDI
                    $reql1 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='LUNDI' AND heure_debut='08:00' AND heure_fin='09:50' AND filiere='$nom_filiere'  ");
                    $reql1->execute();
                    $resultl1 = $reql1->fetchAll();

                    $reql2 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='LUNDI' AND heure_debut='10:10' AND heure_fin='12:00' AND filiere='$nom_filiere' ");
                    $reql2->execute();
                    $resultl2 = $reql2->fetchAll();

                    $reql3 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='LUNDI' AND heure_debut='13:00' AND heure_fin='14:50' AND filiere='$nom_filiere' ");
                    $reql3->execute();
                    $resultl3 = $reql3->fetchAll();

                    $reql4 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='LUNDI' AND heure_debut='15:00' AND heure_fin='17:00' AND filiere='$nom_filiere' ");
                    $reql4->execute();
                    $resultl4 = $reql4->fetchAll();


                    //MARDI
                    $reqma1 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MARDI' AND heure_debut='08:00' AND heure_fin='09:50' AND filiere='$nom_filiere' ");
                    $reqma1->execute();
                    $resultma1 = $reqma1->fetchAll();

                    $reqma2 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MARDI' AND heure_debut='10:10' AND heure_fin='12:00' AND filiere='$nom_filiere' ");
                    $reqma2->execute();
                    $resultma2 = $reqma2->fetchAll();

                    $reqma3 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MARDI' AND heure_debut='13:00' AND heure_fin='14:50' AND filiere='$nom_filiere' ");
                    $reqma3->execute();
                    $resultma3 = $reqma3->fetchAll();

                    $reqma4 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MARDI' AND heure_debut='15:00' AND heure_fin='17:00' AND filiere='$nom_filiere' ");
                    $reqma4->execute();
                    $resultma4 = $reqma4->fetchAll();

                    //MERCREDI
                    $reqme1 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MERCREDI' AND heure_debut='08:00' AND heure_fin='09:50' AND filiere='$nom_filiere' ");
                    $reqme1->execute();
                    $resultme1 = $reqme1->fetchAll();

                    $reqme2 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MERCREDI' AND heure_debut='10:10' AND heure_fin='12:00' AND filiere='$nom_filiere' ");
                    $reqme2->execute();
                    $resultme2 = $reqme2->fetchAll();

                    $reqme3 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MERCREDI' AND heure_debut='13:00' AND heure_fin='14:50' AND filiere='$nom_filiere' ");
                    $reqme3->execute();
                    $resultme3 = $reqme3->fetchAll();

                    $reqme4 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='MERCREDI' AND heure_debut='15:00' AND heure_fin='17:00' AND filiere='$nom_filiere' ");
                    $reqme4->execute();
                    $resultme4 = $reqme4->fetchAll();

                     //JEUDI
                     $reqje1 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='JEUDI' AND heure_debut='08:00' AND heure_fin='09:50' AND filiere='$nom_filiere' ");
                     $reqje1->execute();
                     $resultje1 = $reqje1->fetchAll();
 
                     $reqje2 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='JEUDI' AND heure_debut='10:10' AND heure_fin='12:00' AND filiere='$nom_filiere' ");
                     $reqje2->execute();
                     $resultje2 = $reqje2->fetchAll();
 
                     $reqje3 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='JEUDI' AND heure_debut='13:00' AND heure_fin='14:50' AND filiere='$nom_filiere' ");
                     $reqje3->execute();
                     $resultje3 = $reqje3->fetchAll();
 
                     $reqje4 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='JEUDI' AND heure_debut='15:00' AND heure_fin='17:00' AND filiere='$nom_filiere' ");
                     $reqje4->execute();
                     $resultje4 = $reqje4->fetchAll();

                     //VENDREDI
                     $reqve1 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='VENDREDI' AND heure_debut='08:00' AND heure_fin='09:50' AND filiere='$nom_filiere' ");
                     $reqve1->execute();
                     $resultve1 = $reqve1->fetchAll();
 
                     $reqve2 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='VENDREDI' AND heure_debut='10:10' AND heure_fin='12:00' AND filiere='$nom_filiere' ");
                     $reqve2->execute();
                     $resultve2 = $reqve2->fetchAll();
 
                     $reqve3 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='VENDREDI' AND heure_debut='13:00' AND heure_fin='14:50' AND filiere='$nom_filiere' ");
                     $reqve3->execute();
                     $resultve3 = $reqve3->fetchAll();
 
                     $reqve4 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='VENDREDI' AND heure_debut='15:00' AND heure_fin='17:00' AND filiere='$nom_filiere' ");
                     $reqve4->execute();
                     $resultve4 = $reqve4->fetchAll();

                     //SAMEDI
                     $reqsa1 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='SAMEDI' AND heure_debut='08:00' AND heure_fin='09:50' AND filiere='$nom_filiere' ");
                     $reqsa1->execute();
                     $resultsa1 = $reqsa1->fetchAll();
 
                     $reqsa2 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='SAMEDI' AND heure_debut='10:10' AND heure_fin='12:00' AND filiere='$nom_filiere' ");
                     $reqsa2->execute();
                     $resultsa2 = $reqsa2->fetchAll();
 
                     $reqsa3 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='SAMEDI' AND heure_debut='13:00' AND heure_fin='14:50' AND filiere='$nom_filiere' ");
                     $reqsa3->execute();
                     $resultsa3 = $reqsa3->fetchAll();
 
                     $reqsa4 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='SAMEDI' AND heure_debut='15:00' AND heure_fin='17:00' AND filiere='$nom_filiere' ");
                     $reqsa4->execute();
                     $resultsa4 = $reqsa4->fetchAll();

                     //DIMANCHE
                     $reqdi1 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='DIMANCHE' AND heure_debut='08:00' AND heure_fin='09:50' AND filiere='$nom_filiere' ");
                     $reqdi1->execute();
                     $resultdi1 = $reqdi1->fetchAll();
 
                     $reqdi2 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='DIMANCHE' AND heure_debut='10:10' AND heure_fin='12:00' AND filiere='$nom_filiere'");
                     $reqdi2->execute();
                     $resultdi2 = $reqdi2->fetchAll();
 
                     $reqdi3 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='DIMANCHE' AND heure_debut='13:00' AND heure_fin='14:50' AND filiere='$nom_filiere' ");
                     $reqdi3->execute();
                     $resultdi3 = $reqdi3->fetchAll();
 
                     $reqdi4 = $pdo->prepare("SELECT * FROM programmefiliere WHERE jour='DIMANCHE' AND heure_debut='15:00' AND heure_fin='17:00' AND filiere='$nom_filiere' ");
                     $reqdi4->execute();
                     $resultdi4 = $reqdi4->fetchAll();


                     $periode = $pdo->prepare("SELECT*FROM plagehoraires  ORDER BY id_plage DESC LIMIT 1 ");
                     $periode->execute();

                ?>
                  <div style="width:50%;display:flex;justify-content:space-between">
                            <h1 class="h3 mb-4 text-gray-800" >Programmede cours   <span style="color: rgba(0, 0, 255, 0.632);">  <?php echo $nom_filiere; ?></span></h1>        
                </div>
                  ...
                  <?php foreach ($periode as $rows) : ?>      
                     ...
                     <div  class="card shadow mb-4"><br>
                             ...
                             <div id="periode" >
                                ...
                                <p style="text-align: center;"> Periode du <span style="color: rgba(0, 0, 255, 0.632);font-weight:bold"><?php echo $rows['debut'] ?></span> au <span style="color: rgba(0, 0, 255, 0.632);font-weight:bold"><?php echo $rows['fin'] ?></span></p>
                             </div>
