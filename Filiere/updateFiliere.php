...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
         ...
         <?php
            ...
            $a = $_GET['$idi'];
            $update = $pdo->prepare("SELECT*FROM filiere WHERE id_filiere =$a ");
            $update->execute();
         ...
         <?php foreach ($update as $rowup) : ?>
            <div >
                   <h1 class="h3 mb-4 text-gray-800" >Mise a jour de  <span style="color: rgba(0, 0, 255, 0.632);"><?php echo $rowup['nom_filiere'] ?></span></h1>
              </div>
                     <!-- DataTales Example -->
                                 ...
                                 <div class="first-main">
                                   <select class="input-form"  name="ecole" id="" >
                                     ...
                                     <br><br>
                                      ...
                                      <input placeholder="Nom filiere" value="<?php echo $rowup['nom_filiere'] ?>" name="nom_filiere" class="input-form" type="text"><br><br>
                                      <select class="input-form" aria-placeholder="choisir un Directeur" name="resp_filiere" id="" >
                                        <option value="<?php echo $rowup['resp_filiere'] ?>"><?php echo $rowup['resp_filiere'] ?></option>
                                     ...
                                     <input  name="image" class="input-form" type="file" id="image">
                                      ...
                                      <div style="width: 80%;display: flex;justify-content: space-between;">
                                          ...
                                          <input  name="idi" style="display: none;" value="<?php echo $row['id_filiere'] ?>" type="text">
